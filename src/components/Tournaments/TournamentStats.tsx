      ...
      <div className="p-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            ...
            <div className="text-xs text-blue-600 dark:text-blue-200 mt-1">Tournaments Played</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-500 dark:text-yellow-400">{stats.tournamentsWon.toLocaleString()}</div>
            <div className="text-xs text-blue-600 dark:text-blue-200 mt-1">Tournaments Won</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-slate-900 dark:text-white">#{stats.bestRank}</div>
            <div className="text-xs text-blue-600 dark:text-blue-200 mt-1">Best Rank</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-slate-900 dark:text-white">{stats.totalPoints.toLocaleString()}</div>
            <div className="text-xs text-blue-600 dark:text-blue-200 mt-1">Total Points</div>
          </div>
        </div>
      </div>
    </div>
