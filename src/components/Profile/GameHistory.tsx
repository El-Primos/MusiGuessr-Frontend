        ...
        <table className="w-full">
          ...
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-blue-900/40">
              <th className="px-4 py-3 text-left text-sm font-semibold text-blue-700 dark:text-blue-200">Date</th>
              <th className="px-4 py-3 text-left text-sm font-semibold text-blue-700 dark:text-blue-200">Mode</th>
              <th className="px-4 py-3 text-left text-sm font-semibold text-blue-700 dark:text-blue-200">Score</th>
              <th className="px-4 py-3 text-right text-sm font-semibold text-blue-700 dark:text-blue-200">Actions</th>
            </tr>
          </thead>
            ...
            {gameHistory.map((game) => {
              ...
              return (
                <tr
                  ...
                  className="hover:bg-slate-50 dark:hover:bg-blue-900/20 transition-colors"
                >
                  <td className="px-4 py-3 text-sm text-slate-900 dark:text-white">{game.date}</td>
                  <td className="px-4 py-3 text-sm text-blue-700 dark:text-blue-200">{game.mode}</td>
